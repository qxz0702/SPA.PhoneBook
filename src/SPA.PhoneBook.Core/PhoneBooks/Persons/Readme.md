...
<text name="Person" value=""></text><text name="QueryPerson"  value="查询"></text><text name="CreatePerson"  value="添加"></text><text name="EditPerson"  value="编辑"></text><text name="DeletePerson"  value="删除"></text><text name="BatchDeletePerson" value="批量删除"></text><text name="ExportPerson"  value="导出"></text>                             
